                ...
                <table class="w-full min-w-[700px] table-auto">
                    ...
                    <tbody class="divide-x divide-y divide-gray-200 dark:divide-gray-800">
                        @foreach ($user as $item)
                            <tr class="border-b border-gray-200 dark:divide-gray-800 dark:border-gray-800">
                                <td class="py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">{{ $loop->iteration }}</td>
                                <td class="py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">{{ $item->name }}</td>
                                <td class="py-4 text-left text-xs font-medium text-gray-500 dark:text-gray-400">{{ $item->email }}</td>
                                @if ($item->role == 'Super Admin')
                                    <td class="text-blue-100 font-bold items-center text-sm">
                                        <div class="text-center py-0.5 w-26 bg-green-600 rounded-md">{{ $item->role }}</div>
                                    </td>
                                @elseif ($item->role == 'Admin')
                                    <td class="text-green-100 font-bold items-center text-sm">
                                        <div class="text-center py-0.5 w-26 bg-blue-600 rounded-md">{{ $item->role }}</div>
                                    </td>
                                @endif
                                <td class="items-center">
                                    <button class="bg-yellow-500 hover:bg-yellow-600 inline-flex h-8 w-8 items-center justify-center rounded-lg text-white transition">
                                        <i class="fas"></i>
                                    </button>
                                    <button class="bg-red-500 hover:bg-red-600 inline-flex h-8 w-8 items-center justify-center rounded-lg text-white transition">
                                        <i class="trash"></i>
                                    </button>
                                </td>
                            </tr>
