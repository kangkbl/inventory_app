<div>
    ...
    <div class="p-4 pb-20 md:p-6 md:pb-6">
                ...
                <div
                    class="rounded-2xl border border-gray-200 bg-white lg:p-6 dark:border-gray-800 dark:bg-white/[0.03]">
                    ...
                    <div class="custom-scrollbar max-h-[500px] overflow-x-auto">
                        <table class="w-full table-auto">
                            <thead class="divide-x divide-y divide-gray-200 dark:divide-gray-800">
