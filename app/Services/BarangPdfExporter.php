...
class BarangPdfExporter
{
    ...
    private const PAGE_MARGIN_TOP = 40.0;
    ...
    private const FONT_RELATIVE_PATH = 'fonts/Gotham-Light.otf';
    private const LOGO_MAX_WIDTH = 80.0;
    private const LOGO_MAX_HEIGHT = 40.0;
    private const LOGO_LEFT_OFFSET = 30.0;
    private const LOGO_BOTTOM_SPACING = 20.0;
    ...
    private function calculateWrapLimit(float $columnWidth, float $fontSize): int
    {
        ...
        $characters = (int) floor($usableWidth / ($fontSize * self::CHARACTER_DEFAULT_RATIO));
